...
def mylicence():
    ...
    pin = "743144"
    print(type(pin))
    address = "3NO. BAPUJI COLONY, FLAT-4A, GEETA ABASAN, EAST MANICKTALA, ICHAPUR, KOLKATA - 743144"
    print(type(address))
    vehicle_type = "LAMBORGHINI AVENTADOR FOUR WHEEL"
...
button1 = Button(root, text="Show Your Driving Licence", command = mylicence)
button1.pack()
